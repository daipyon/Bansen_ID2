...
async function Pattern2(Row, WorkData) {
  ...
  // 優先度(O列)を入力
  const GoalPriority = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[8]/div[2]/div/div/div/div/div/span[1]/div[2]/input');
  ...
  // 総目標imp(P列)を入力
  const GoalGimp = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[9]/div[2]/div/input');
...
async function Pattern3(Row, WorkData) {
  ...
  await RPA.sleep(1000);
  // 訴求シリーズID(R列)を入力
  const CampaignPromoSeriesId = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[8]/div[2]/div/div[1]/input');
  await RPA.WebBrowser.sendKeys(CampaignPromoSeriesId,[WorkData[0][0][17]]);
  // カスタムオーディエンス(S列)を入力
  const CustomAudience = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[10]/div[2]/div/div/div/div/div/span[1]/div[2]/input');
...
async function Pattern4(Row, WorkData) {
  ...
  await RPA.sleep(1000);
  // 訴求シリーズID(R列)を入力
  const CampaignPromoSeriesId = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[9]/div[2]/div/div[1]/input');
  await RPA.WebBrowser.sendKeys(CampaignPromoSeriesId,[WorkData[0][0][17]]);
  // 指定シリーズID(Q列)を入力
  const CampaignSpecifiedSeriesId = await RPA.WebBrowser.findElementByXPath('/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[8]/div[2]/div/div[1]/div[2]/textarea');
  ...
  await RPA.WebBrowser.driver.executeScript(
    ...
    `document.querySelectorAll("#reactroot > div > div.Modal__overlay___3CdlJ.Modal__full___3Mi9N.Modal__opened___-zyiB > div.Modal__modal___15eHS.Modal__full___3Mi9N > div.Modal__body___2lTdW.Modal__full___3Mi9N > div > form > div > div:nth-child(4) > div.FieldGroup__container___3fkr0 > div > div:nth-child(8) > div.Field__value___3-hi8 > div > div.Field__container___2rw9q.Field__column___2-TfA.Field__labelInline___2GdCv.Field__noMargin___1oAyZ.Field__alignNone___1dlxQ > div.Field__value___3-hi8 > textarea")[0].value = decodeURI("${Text1}");`
  );
...
async function Pattern4JudgeError(WorkData, Row) {
  ...
  if (WorkData[0][0][16].length < 1) {
    ...
    const NotCampaignSpecifiedSeriesId = await RPA.WebBrowser.wait(RPA.WebBrowser.Until.elementLocated({xpath:'/html/body/div[1]/div/div[5]/div[2]/div[1]/div/form/div/div[4]/div[7]/div/div[8]/div[2]/div/div[2]/div[2]/div/div[2]'}),1000);
