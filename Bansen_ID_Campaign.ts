...
// スプレッドシートIDとシート名
const SSID = "1kD1JW8Fu4cu4ng3pgdNVMyh_X59VMg77IIWkyR4tJ7U";
const SSName = "ID円滑（キャンペーン・広告）";
const SSName2 = "キャンペーン・広告貼り付け";
// Abematvのログイン用メールアドレス・パスワードの記載 <<漏洩注意>>
const AbematvID = "fusato_gaku@abema.tv";
const AbematvPW = "zektbacH0310";
// AAAMS(本番環境)のログイン用メールアドレス・パスワード
const AAAMSID = "rpa@example.com";
const AAAMSPW = "XPHPzJ69ySu_!Zu";
